...
filename='dsge_irf_R_varying_noadjust.csv'
with open(filename, 'a', newline='') as myfile:
    csvwriter = writer(myfile)
    to_list = [
        'R-notadjust-consume',
        'R-notadjust-investment',
        'R-notadjust-Laobr',
    'R-notadjust-houseprice',
    'R-notadjust-Nonhouseprice',
    'R-notadjust-GDP',
    'R-notadjust-NonhouseProduction',
    'R-notadjust-financegap',
    'R-notadjust-homeleverage']
...
Initial_value=Main_DSGE.R
Main_DSGE.R+=0.01092
print("Finish")
while po<simulated_times:
    with open(filename, 'a',newline='') as myfile:
        q.simulation_bystep()
        Main_DSGE.R=Initial_value
        csvwriter = writer(myfile)
        to_list =[
            q.C-stable_C ,
        q.I-stable_I ,
